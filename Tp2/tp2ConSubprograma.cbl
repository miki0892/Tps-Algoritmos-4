      ...
      -    'itmos-4/Tp2/Archivos de prueba/Secuenciales/listado.dat'.
       ...
       RUTINAS-ENTRADA SECTION.
           ...
           ABRIR-ARCHIVOS.
               ...
               MOVE 'A' TO OPCION-EMP.
               CALL 'OBTENER-EMPRESA' USING OPCION-EMP.
           ...
           BUSCAR-RAZON-SOCIAL.
               MOVE 'P' TO OPCION-EMP.
               CALL 'OBTENER-EMPRESA'
                    USING OPCION-EMP,TIE-CUIT,RAZON-ACTUAL.
               MOVE RAZON-ACTUAL TO ORD-RAZON.
           ...
           CERRAR-ARCHIVOS.
               CLOSE TIEMPOS CONSULTORES TARIFAS PARAMETROS.
               MOVE 'C' TO OPCION-EMP.
               CALL 'OBTENER-EMPRESA' USING OPCION-EMP.
