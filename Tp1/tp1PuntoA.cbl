      ...
      ******************************************************************
       ...
       FD NOVTIMES1 LABEL RECORD IS STANDARD
                    VALUE OF FILE-ID IS '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/novTimes1.dat'.
       01 NOV1-REG    .
       ...
       FD NOVTIMES2 LABEL RECORD IS STANDARD
                    VALUE OF FILE-ID IS '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/novTimes2.dat'.
       01 NOV2-REG    .
       ...
       FD NOVTIMES3 LABEL RECORD IS STANDARD
                    VALUE OF FILE-ID IS '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/novTimes3.dat'.
       01 NOV3-REG    .
       ...
       FD TIEMPOS LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/times.dat'.
       01 TIE-REG.
       ...
       FD TIEMPOS-NEW LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/timesNew.dat'.
       01 TIE-NEW-REG.
       ...
       FD EMPRESAS LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/empresas.dat'.
       01 EMP-REG.
       ...
       FD CONSULTORES LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -       'ps-Algoritmos-4/Tp1/Archivos de prueba/consultores.dat'.
       01 CONS-REG.
       ...
       FD TARIFAS LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/tarifas.dat'.
       01 TAR-REG.
           03 TAR-SRT PIC X(02).
           03 TAR-TIPO PIC 99.
       ...
       FD TIPOS LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/tipos.dat'.
       01 TIP-REG.
           03 TIP-TIPO PIC X(02).
           03 TIP-DESC PIC X(10).
       FD CATEGORIAS LABEL RECORD IS STANDARD
                   VALUE OF FILE-ID IS  '/home/miki/Escritorio/Algos 4/T
      -         'ps-Algoritmos-4/Tp1/Archivos de prueba/categorias.dat'.
       01 CAT-REG.
           03 CAT-SRT PIC X(02).
           03 CAT-DESC PIC X(20).
       FD LISTADO LABEL RECORD IS STANDARD
                  VALUE OF FILE-ID IS   '/home/miki/Escritorio/Algos 4/T
      -          'ps-Algoritmos-4/Tp1/Archivos de prueba/listado.dat'.
       01 LINEA PIC X(80).
